...
namespace REFU
{
    ...
    {//代码生成结构
        ...
        public TypeFieldInfo[] typeFields;
        public string use_namespace = "";

        public CodeGenerateData(string SourcefileName, string typeName,
            TypeFieldInfo[] typeFields, string use_namespace = "")
        {
            this.SourcefileName = SourcefileName;
            this.typeName = typeName;
            this.typeFields = typeFields;
            this.use_namespace = use_namespace;
        }
    }
    ...
    public class CodeGenerator
    {
        ...
        public static void CreateType(CodeGenerateData codeGenerateData)
        {
            CreateType(codeGenerateData.SourcefileName, codeGenerateData.typeName,
                codeGenerateData.typeFields, codeGenerateData.use_namespace);
        }
